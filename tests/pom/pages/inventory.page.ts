...
export class InventoryPage {
	...
	constructor(page: Page) {
		...
		this.addToCartButtons = {
			"sauce-labs-backpack": page.locator(
				'[data-test="add-to-cart-sauce-labs-backpack"]',
			),
			"sauce-labs-bike-light": page.locator(
				'[data-test="add-to-cart-sauce-labs-bike-light"]',
			),
			"sauce-labs-bolt-t-shirt": page.locator(
				'[data-test="add-to-cart-sauce-labs-bolt-t-shirt"]',
			),
			"sauce-labs-fleece-jacket": page.locator(
				'[data-test="add-to-cart-sauce-labs-fleece-jacket"]',
			),
			"test-allthethings-t-shirt-red": page.locator(
				'[data-test="add-to-cart-test\\.allthethings\\(\\)-t-shirt-\\(red\\)"]',
			),
			"sauce-labs-onesie": page.locator(
